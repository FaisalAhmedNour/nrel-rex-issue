...
export const FilterComponent = ({
    ...
    const handleClearForm = () => {
        setFormData({ selectedYear: currentYear });
        handleClear();
    }
                ...
                <div className={`px-1 space-y-1 ${isExpand.reference ? 'visible' : 'hidden'}`}>
                    <div className="flex flex-col items-start ">
                        ...
                        <TextField
                            ...
                            onChange={(e) => setFormData(pre => ({ ...pre, "invoice_no": e.target.value.replace(/\s/g, ',') }))}
                    ...
                    <div className="flex flex-col items-start ">
                        ...
                        <TextField
                            ...
                            value={formData?.["exp_serial"] || ''}
                            onChange={(e) => setFormData(pre => ({ ...pre, "exp_serial": e.target.value.replace(/\s/g, ',') }))}
                            placeholder="Ex:- 123,456,..."
                            type="text"
                            size="small"
                            name="exp_serial"
